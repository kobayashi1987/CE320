...
def visualize_similarity_matrix(similarity_df, title="Cosine Similarity between Programmers"):
    """
    Visualizes the cosine similarity matrix using a heatmap.
    ...
    sns.heatmap(similarity_df, annot=True, fmt=".2f", cmap='YlGnBu', square=True)
    plt.title(title)
